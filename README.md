...
[![Build Status](https://dev.azure.com/vgruicic/vgruicic/_apis/build/status/vladimir-gruicic.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/vgruicic/vgruicic/_build/latest?definitionId=1&branchName=master)
